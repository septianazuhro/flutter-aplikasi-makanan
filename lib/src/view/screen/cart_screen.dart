import 'package:flutter_japanese_restaurant_app/succes_cart.dart';
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "\Rp.${controller.cartFood[index].price}",
                      style: Theme.of(context).textTheme.headlineSmall,
                    ),
                  ],
                ),
                ...
                Column(
                  children: [
                    ...
                    Text(
                      "\Rp.${controller.calculatePricePerEachItem(controller.cartFood[index])}",
